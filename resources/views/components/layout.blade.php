...
<footer class="bg-blue-900 dark:bg-gray-900">
      ...
      <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
        <div>
            ...
            <ul class="text-white dark:text-gray-400 font-medium">
                <li class="mb-4">
                    <a href="#" class=" hover:underline">Vehicles</a>
                </li>
                <li class="mb-4">
                    <a href="#" class="hover:underline">Electronics</a>
                </li>
                <li class="mb-4">
                    <a href="#" class="hover:underline">Outof Hand</a>
                </li>
                <li class="mb-4">
                    <a href="#" class="hover:underline">Auctions</a>
                </li>
            </ul>
        </div>
        <div>
        ...
        <div>
            ...
            <ul class="text-white dark:text-gray-400 font-medium">
                ...
                <li class="mb-4">
                    <a href="#" class="hover:underline">Online Bidding Process</a>
                </li>
            </ul>
        </div>
        <div>
            <h2 class="mb-6 text-sm font-semibold text-white uppercase dark:text-white">More</h2>
            <ul class="text-white dark:text-gray-400 font-medium">
                <li class="mb-4">
    ...
    <div class="px-4 py-6 bg-blue-900 dark:bg-gray-700 md:flex md:items-center md:justify-between border-t-4">
        <span class="text-sm text-white dark:text-gray-300 sm:text-center">© 2023 <a href="https://flowbite.com/">Glowtrack</a>. All Rights Reserved.
        </span>
